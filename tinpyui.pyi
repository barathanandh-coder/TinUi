...
def create_context(name: str, default: Any = None) -> str: ...
def provide_context(name: str, value: Any) -> None: ...
def use_context(name: str, default: Any = None) -> Any: ...

# Modern Component Primitives (Radix / Shadcn Suite)
class Dialog(Node):
    open_signal: Signal
    show_close_button: bool
    def __init__(self, title: str = "", open: Union[bool, Signal] = False, on_close: Optional[Callable[[], None]] = None, width: str = "540px", show_close_button: bool = True, **kwargs): ...
    def show(self) -> None: ...
    def close(self) -> None: ...
...
class Tabs(Node):
    ...
    def __init__(self, default_value: str = "", value: Optional[Union[str, Signal]] = None, on_change: Optional[Callable[[str], None]] = None, variant: str = "underline", **kwargs): ...
    def set_active(self, tab_value: str) -> None: ...
...
class AccordionItem(Node):
    open_signal: Signal
    def __init__(self, title: str, open: Union[bool, Signal] = False, icon: Optional[str] = None, on_toggle: Optional[Callable[[bool], None]] = None, **kwargs): ...
    def toggle(self) -> None: ...

class Select(Node):
    selected_signal: Signal
    def __init__(self, options: List[Union[str, Dict[str, str]]], bind: Optional[Signal] = None, placeholder: str = "Select an option...", label: str = "", on_change: Optional[Callable[[str], None]] = None, **kwargs): ...

class Dropdown(Select): ...

class Popover(Node):
    open_signal: Signal
    def __init__(self, title: str = "", open: Union[bool, Signal] = False, position: str = "bottom", **kwargs): ...

class ToastManager:
    toasts: Signal
    def __init__(self): ...
    def show(self, message: str, variant: str = "info", duration: float = 3.5, title: Optional[str] = None) -> str: ...
    def success(self, message: str, title: str = "Success", duration: float = 3.5) -> str: ...
    def error(self, message: str, title: str = "Error", duration: float = 4.5) -> str: ...
    def warning(self, message: str, title: str = "Warning", duration: float = 4.0) -> str: ...
    def info(self, message: str, title: str = "Info", duration: float = 3.5) -> str: ...
...
# Two-Way Reactive Form State & Live Validation Suite
...
class FormField(Node):
    ...
    is_dirty: Signal
    def __init__(self, label: str = "", bind: Optional[Signal] = None, name: Optional[str] = None, type: str = "text", placeholder: str = "", rules: Optional[List[Callable[[Any], Optional[str]]]] = None, helper_text: str = "", required: bool = False, **kwargs): ...
    def validate(self) -> Optional[str]: ...

class Form(Node):
    is_form_valid: Signal
    def __init__(self, on_submit: Optional[Callable[[Dict[str, Any], bool], None]] = None, on_change: Optional[Callable[[Dict[str, Any]], None]] = None, gap: int = 16, padding: int = 24, card: bool = True, title: Optional[str] = None, **kwargs): ...
...
class Route(Node):
    pattern_path: str
    component: Optional[Union[Node, Callable[..., Node]]]
    title: Optional[str]
    def __init__(self, path: str, component: Optional[Union[Node, Callable[..., Node]]] = None, title: Optional[str] = None, **kwargs): ...
...
class Router(Node):
    ...
    active_route: Signal
    routes: List[Route]
    def __init__(self, routes: Optional[List[Route]] = None, initial_path: str = "/", mode: str = "history", **kwargs): ...
